...
namespace gltfr {
    bool g_forceExternalShaders;

	class GltfDDGIElement : public nvvkhl::IAppElement {
	public:
		GltfDDGIElement(){}
      ...
      //
        void onAttach(nvvkhl::Application* app) override
        {
            ...
            g_inFilename = "D:\\project\\vk_mini_samples\\media\\cornellBox.gltf";
    ...
    private:
        ...
        void createRenderers()
        {
            ...
            m_renderer = makeRendererRaster();//makeRendererDDGIRaster();
...
auto main(int argc, char** argv) -> int
{
    ...
    auto gltfRenderer = std::make_shared<gltfr::GltfDDGIElement>();  // This is the main element of the application
